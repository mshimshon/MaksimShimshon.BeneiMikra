...
public interface IStrapiBuilder
{
    ...
    IStrapiBuilder RestrictFieldTo<TEntity>(Expression<Func<TEntity>> property, StrapiFilterOperator @operator, string value);
    IStrapiBuilder Filter(string[] fields, StrapiFilterOperator @operator, string value);
    IStrapiBuilder Filter<TEntity>(Expression<Func<TEntity>> property, StrapiFilterOperator @operator, string value);
    ...
    IStrapiBuilder AddSort<TEntity>(Expression<Func<TEntity>> property, StrapiShortDirection direction = StrapiShortDirection.Ascending);
