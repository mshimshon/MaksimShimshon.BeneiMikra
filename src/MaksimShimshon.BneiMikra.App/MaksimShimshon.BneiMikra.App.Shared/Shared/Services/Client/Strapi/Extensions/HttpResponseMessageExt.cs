using MaksimShimshon.BneiMikra.App.Shared.Shared.Services.Client.Strapi.Dto;
using System.Text.Json;
using System.Text.Json.Nodes;

namespace MaksimShimshon.BneiMikra.App.Shared.Shared.Services.Client.Strapi.Extensions;
internal static class HttpResponseMessageExt
{
    public static async Task<StrapiResponse<TData>> IsStrapiResponse<TData>(
